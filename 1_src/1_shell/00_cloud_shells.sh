...
#python /Users/jjespinoza/GoogleDrive/2_projects/2_itsfriday/1_src/2_python/2_pull_indeed.py
...
#gsutil cp /Users/jjespinoza/GoogleDrive/2_projects/2_itsfriday/2_data/1_raw/scraper_indeed_jobs_.csv gs://indeed-scraper
