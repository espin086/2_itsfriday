...
city_set = ['Los+Angeles', 'Los+Angeles+County',
            'Long+Beach', 'Downey', 'Commerce', 'El+Segundo']
#title_set = ['data+scientist']
title_set = ['data+scientist', 'senior+data+scientist', 'director+data+science',
             'director+analytics', 'vice+president+analytics', 'vice+president+data+science']
columns = ['city', 'job_title', 'company_name',
